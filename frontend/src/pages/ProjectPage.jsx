...
const projects = [
  ...
  },
  {
    ...
    description: "BST Visualizer is a learning tool that visually represents Binary Search Tree operations including insertion, deletion, and traversal. Designed for students and developers to interactively explore how data structures work in real time. With D3.js animations and a React UI, users can control the pace of visualizations and better grasp core CS concepts.",
  ...
  image: hangman, // Replace with the correct import for the image
  ...
  },
  {
    id: 4,
    title: "StoryApp",
    description: "StoryApp is a MERN-stack based travel story platform where users can create, edit, and manage their travel experiences. Features include user authentication with JWT, media uploads using Multer, story search by date or keywords, and a personalized dashboard. Built with responsive design and optimized data flow using Context API and Axios.",

    image: travel,
    tags: ["React.js", "Node.js", "MongoDB", "Express.js", "JWT", "Multer", "Axios", "Context API"],
      ...
      <div className="container mx-auto max-w-5xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {projects.map((project) => (
            <div key={project.id} className="[perspective:1000px] w-full h-[360px]">
              <div className="relative w-full h-full transition-transform duration-700 transform-style-preserve-3d hover:rotate-y-180">
                ...
                <div className="absolute w-full h-full bg-card rounded-lg shadow-md rotate-y-180 backface-hidden p-4 flex flex-col justify-between">
                  <p className="text-sm mb-2 text-muted-foreground">{project.description}</p>
