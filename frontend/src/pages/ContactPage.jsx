...
const ContactPage = () => {
  ...
  try {
    const response = await axios.post("https://portfolio-9jcm.onrender.com/api/contact", {
      name,
      email,
      message,
    });
 ...
 return (
    ...
    <section id="contact" className="py-24 px-4 relative bg-transparenttext-foreground" >
      <ThemeToggle />
